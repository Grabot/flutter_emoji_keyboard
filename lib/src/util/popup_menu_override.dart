...
const double _kMenuMaxWidth = 1.0 * _kMenuWidthStep;
    ...
    itemBuilder: (BuildContext ctx, index) {
      return Container(
        ...
        child: TextButton(
            ...
            child: Text(testAgain[index], style: TextStyle(fontSize: 25))),
      );
    });
    // return Container(
    //     child: getPopupItems(context)
    // );
  }
}
